...
class Robot:
    ...
    def __init__(self, kind=1, start=None):
        ...
        pygame.draw.polygon(surf, (63, 0, 63),
                            [(self.scale * 2, 0), (self.scale, self.scale), (self.scale * 2, self.scale * 2)])
        pygame.draw.polygon(surf, (207, 191, 63),
                            [(0, self.scale * 2), (self.scale, self.scale), (self.scale * 2, self.scale * 2)])
        ...
        self.b = gamebox.from_circle(self.scale * 3, self.scale * 3, 'white', self.scale // 2, 'black',
                                     3 * self.scale // 8)
        self.eye = gamebox.from_circle(self.scale * 3, self.scale * 3, 'black', self.scale // 2, 'white',
                                       7 * self.scale // 16)
